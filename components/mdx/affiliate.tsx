...
const Affiliate = ({ asin, id, label }: AffiliateProps) => {
  return (
    ...
    `}>
      ...
      />
      <img src={`//ws-fe.amazon-adsystem.com/widgets/q?_encoding=UTF8&MarketPlace=JP&ASIN=${asin}&ServiceVersion=20070822&ID=AsinImage&WS=1&Format=_SL250_&tag=midorimici06-22`} />
