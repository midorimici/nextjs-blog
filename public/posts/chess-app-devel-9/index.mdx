...
<postimage src="goal" ext="gif" alt="完成図" />
...
```py name=main.py hl_lines=2,8,9,10,14-22,28,33-38,53-56
...
...
これで<inlink to="#完成イメージ">完成イメージ</inlink>と同じような動作ができるようになりました。
