...
topics: [ブログ, サイト構築, Hugo, Netlify, ツール]
published: true
---
...
<postimage src="add-build-hook" ext="png" alt="Build hook 追加" />
...
<postimage src="build-hook-command" ext="png" alt="Build hook コマンド" />
...
<postimage src="github-secret" ext="png" alt="GitHub Secrets" />
...
の<strong><icode>date</icode>の日付を投稿したい日時に合わせます。
</strong></p>
