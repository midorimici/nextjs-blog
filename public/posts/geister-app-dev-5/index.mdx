...
<pstlk label="前回" to="geister-app-dev-4" />は初期盤面を生成して描画しました。
...
```py name=main.py hl_lines=2-9,15-18,30-44 inline_hl=2:6-9;15:7-8
...
...
<pstlk label="次回" to="geister-app-dev-6" />は勝利条件を判定して、勝者を表示するところまでやりたいと思います。
