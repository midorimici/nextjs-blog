...
<manga-text x={8} y={9} text="あ、そういえば<br/>広告を入れたって<br/>言ってたな" />

<manga-text x={52} y={15} text="クリックしてあげよ" />

<manga-text x={12} y={76} text="え、あんまり触るなって<br/>言われなかった…？" />
...
<manga-text x={11} y={10} text="でも記事が上がるたびに<br/>一回クリックするぐらいだよ？" />

<manga-text x={54} y={29} text="そんなに多くないから<br/>よくない？" />

<manga-text x={34} y={82} text="**十二分に多いよ！**" />
...
<manga-text x={20} y={21} text="じゃあどれぐらいの<br/>頻度ならいいのさ？" />

<manga-text x={68} y={14} text="えっと…<br/>もう二度と<br/>クリックしない<br/>ほうがいいと思う" />
...
<manga-text x={64} y={12} text="Google Adsense の<br/>仕組みについて<br/>見ていこう" />
...
<manga-text x={60} y={82} text="サイト運営者だけが<br/>関わっているわけじゃない" />
...
<manga-text x={40} y={82} text="だから**意図的に何度もクリックするのは<br/>広告主にめちゃくちゃ迷惑をかける**わけ" />
