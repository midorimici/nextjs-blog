...
lastmod: 2020-08-23T12:00:00+09:00
...
のような静的サイトジェネレータにも、
{{% tooltip %}}CMS((コンテンツ管理システム{{% /tooltip %}}
を導入することができます。
</p>
...
{{< img src=forestry-select-ssg alt="SSG 選択" >}}
...
{{< img src=forestry-select-hugo-v alt="hugo version 選択" >}}

次にコードの置き場所を指定します。

{{< img src=forestry-select-git alt="git provider 選択" >}}

認証をしてから、サイトが置いてある git のリポジトリとブランチを選択します。

しばらく待つと、ダッシュボードに入ることができます。

{{< img src=welcome-to-cms alt="Forestry.io ダッシュボード" >}}
...
{{< img src=forestry-settings-sidebar alt="サイドバー設定" >}}
...
{{< img src=config-1 alt="config.toml" >}}

{{< img src=config-2 alt="config.toml" >}}

{{< img src=config-3 alt="config.toml" >}}
...
{{< img src=add-field alt="Add Field" >}}
...
{{< img src=forestry-test alt="Forestry.io 編集画面" >}}
...
{{< img src=icons ext=gif alt="編集画面 アイコン" >}}
