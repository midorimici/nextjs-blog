...
<postimage src="fukidashi" ext="gif" alt="プロモーション 吹き出し" />
...
```py name=pieces.py ins=2,4 del=1,3 inline_hl=1:3;2:3;3:3;4:3
WHITE = "white"
WHITE = "W"
BLACK = "black"
BLACK = "B"
...
<postimage src="fukidashi_sentakushi" alt="プロモーション 吹き出し 駒あり" />
...
<postimage src="promotion" ext="gif" alt="プロモーション 完成" />
