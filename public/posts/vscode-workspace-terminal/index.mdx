...
<p>
私が
{{% tooltip %}}VS Code（Visual Studio Code）((Microsoft 製コードエディタ<br>[公式サイト](https://code.visualstudio.com/){{% /tooltip %}}
を使い始めたときは、
</p>
...
{{< img src=terminal-dropdown alt="VS Code ドロップダウン" >}}
